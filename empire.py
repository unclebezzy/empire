...
"""
Empire Multiplatform Chatbot Spawner
Version 0.1
By Uncle Bezzy
"""
...
def main(argv):
    ...
    for opt, arg in opts:
        if opt in ("-h", "--help"):
            ...
            print("")
            print("A multiplatform ML chatbot spawner aimed at mass social engineering attacks")
            print("")
            print("ARGUMENTS:")
            ...
            print("Empire Multiplatform Bot Spawner")
            print("Version 0.1")
